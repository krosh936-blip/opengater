...
const translations: Record<Language, Record<string, string>> = {
  ru: {
    ...
    'auth.welcome_subtitle': 'Вы можете использовать электронную почту\nили Telegram для входа или регистрации',
    'auth.email_label': 'Адрес электронной почты',
    'auth.continue': 'Продолжить',
    'auth.continue_as': 'Продолжить как',
    'auth.login_other_account': 'Войти в другой аккаунт',
    'auth.quick_account': 'Аккаунт',
    'auth.telegram_continue': 'Продолжить с Telegram',
    'auth.token_button': 'Войти',
    'auth.email_required': 'Введите email или user_id',
    'auth.email_invalid': 'Введите корректный email',
    'auth.email_code_title': 'Проверьте входящие',
    'auth.email_code_subtitle': 'Введите код подтверждения, который мы отправили на {email}',
    'auth.code_label': 'Код',
    'auth.code_required': 'Введите код',
    'auth.verify': 'Подтвердить',
    'auth.resend_code': 'Отправить код повторно',
    'auth.resend_in': 'Повторно через {seconds} сек',
    'auth.change_email': 'Изменить email',
    ...
    'profile.telegram_link_failed': 'Telegram не привязан',
    'profile.add_telegram': 'Добавить Telegram',
    'profile.email_linked_success': 'Email привязан',
    'profile.link_email_requires_auth': 'Для привязки email нужен вход через Telegram или email',
    'profile.link_telegram_requires_auth': 'Для привязки Telegram нужен вход через Telegram или email',
    'profile.popup_blocked': 'Всплывающее окно заблокировано',
  ...
  en: {
    ...
    'auth.welcome_subtitle': 'You can use email\nor Telegram to sign in or register',
    'auth.email_label': 'Email address',
    'auth.continue': 'Continue',
    'auth.continue_as': 'Continue as',
    'auth.login_other_account': 'Log in to another account',
    'auth.quick_account': 'Account',
    'auth.telegram_continue': 'Continue with Telegram',
    'auth.token_button': 'Sign in',
    'auth.email_required': 'Enter email or user_id',
    'auth.email_invalid': 'Enter a valid email',
    'auth.email_code_title': 'Check your inbox',
    'auth.email_code_subtitle': 'Enter the code we sent to {email}',
    'auth.code_label': 'Code',
    'auth.code_required': 'Enter the code',
    'auth.verify': 'Verify',
    ...
    'profile.telegram_link_failed': 'Telegram not linked',
    'profile.add_telegram': 'Add Telegram',
    'profile.email_linked_success': 'Email linked',
    'profile.link_email_requires_auth': 'To link email, sign in via Telegram or email',
    'profile.link_telegram_requires_auth': 'To link Telegram, sign in via Telegram or email',
    'profile.popup_blocked': 'Popup was blocked',
  ...
  am: {
    ...
    'profile.telegram_link_failed': "Telegram-ը չկապվեց",
    'profile.add_telegram': "Ավելացնել Telegram",
    'profile.email_linked_success': "Email-ը կապված է",
    'profile.link_email_requires_auth': "Email կապելու համար մուտք գործեք Telegram-ով կամ email-ով",
    'profile.link_telegram_requires_auth': "Telegram կապելու համար մուտք գործեք Telegram-ով կամ email-ով",
    'profile.popup_blocked': "Բացվող պատուհանը արգելափակվել է",
    ...
    'auth.use_token': "Մուտք գործել թոքենով",
    'auth.token_placeholder': "Տեղադրեք թոքենը",
    'auth.or': "կամ",
    'auth.welcome_title': "Բարի գալուստ",
    'auth.welcome_subtitle': "Կարող եք օգտագործել էլ. փոստը\nկամ Telegram-ը մուտքի կամ գրանցման համար",
    'auth.email_label': "Էլ. փոստի հասցե",
    'auth.continue': "Շարունակել",
    'auth.continue_as': "Շարունակել որպես",
    'auth.login_other_account': "Մուտք այլ հաշվի",
    'auth.quick_account': "Հաշիվ",
    'auth.telegram_continue': "Շարունակել Telegram-ով",
    'auth.token_button': "Մուտք",
    'auth.email_required': "Մուտքագրեք email կամ user_id",
    'auth.email_invalid': "Մուտքագրեք ճիշտ email",
    'auth.email_code_title': "Ստուգեք մուտքային փոստը",
    'auth.email_code_subtitle': "Մուտքագրեք հաստատման կոդը, որը ուղարկել ենք {email} հասցեին",
    'auth.code_label': "Կոդ",
    'auth.code_required': "Մուտքագրեք կոդը",
    'auth.verify': "Հաստատել",
    'auth.resend_code': "Կրկին ուղարկել կոդը",
    'auth.resend_in': "Կրկնել {seconds} վրկ հետո",
    'auth.change_email': "Փոխել email",
